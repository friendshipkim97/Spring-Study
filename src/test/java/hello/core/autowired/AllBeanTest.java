...
public class AllBeanTest {
    ...
    @Test
    void findAllBean(){
        ApplicationContext ac = new AnnotationConfigApplicationContext(AutoAppConfig.class, DiscountService.class); // 컨테이너에 스프링 빈을 등록하는 과정
    ...
    static class DiscountService{
        ...
        @Autowired // 스프링 빈이라면, 생성자가 1개만 있으면 @Autowired를 생략할 수 있다.
